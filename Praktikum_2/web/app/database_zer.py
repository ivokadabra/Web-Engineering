...
from . import dataid_zer

#----------------------------------------------------------
class Database_clsz(object):
#----------------------------------------------------------
   ...
   #-------------------------------------------------------
      self.data_o = None
      self.maxId_o = dataid_zer.DataId_clsz()
      self.readData_p()
   ...
   #-------------------------------------------------------
      try:
         fp_o = codecs.open( 'webteams/data/zer.json', 'r', 'utf-8')
      except:
         self.data_o = {}
         self.saveData_p()
      else:
   ...
   def saveData_p(self):
   #-------------------------------------------------------
      with codecs.open('webteams/data/zer.json', 'w', 'utf-8') as fp_o:
