...
from . import dataid_s

#----------------------------------------------------------
class Database_clss(object):
#----------------------------------------------------------
   ...
   #-------------------------------------------------------
      self.data_o = None
      self.maxId_o = dataid_s.DataId_clss()
      self.readData_p()
   ...
   #-------------------------------------------------------
      try:
         fp_o = codecs.open( 'webteams/data/status_mit.json', 'r', 'utf-8')
      except:
         self.data_o = {}
         self.saveData_p()
      else:
   ...
   def saveData_p(self):
   #-------------------------------------------------------
      with codecs.open('webteams/data/status_mit.json', 'w', 'utf-8') as fp_o:
