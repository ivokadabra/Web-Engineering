...
from . import dataid_status

#----------------------------------------------------------
class Database_cls(object):
#----------------------------------------------------------
   ...
   #-------------------------------------------------------
      self.data_o = None
      self.maxId_o = dataid_status.DataId_cls()
      self.readData_p()
   ...
   #-------------------------------------------------------
      try:
         fp_o = codecs.open( 'webteams/data/status.json', 'r', 'utf-8')
      except:
         self.data_o = {}
         self.saveData_p()
      else:
   ...
   def saveData_p(self):
   #-------------------------------------------------------
      with codecs.open('webteams/data/status.json', 'w', 'utf-8') as fp_o:
