...
from . import dataid_weit

#----------------------------------------------------------
class Database_clw(object):
#----------------------------------------------------------
   ...
   #-------------------------------------------------------
      self.data_o = None
      self.maxId_o = dataid_weit.DataId_clw()
      self.readData_p()
   ...
   #-------------------------------------------------------
      try:
         fp_o = codecs.open( 'webteams/data/weitid.json', 'r', 'utf-8')
      except:
         self.data_o = {}
         self.saveData_p()
      else:
   ...
   def saveData_p(self):
   #-------------------------------------------------------
      with codecs.open('webteams/data/weitid.json', 'w', 'utf-8') as fp_o:
