...
from . import dataid_qual_in_weit

#----------------------------------------------------------
class Database_clqiw(object):
#----------------------------------------------------------
   ...
   #-------------------------------------------------------
      self.data_o = None
      self.maxId_o = dataid_qual_in_weit.DataId_clqiw()
      self.readData_p()
   ...
   #-------------------------------------------------------
      try:
         fp_o = codecs.open( 'webteams/data/qual_in_weit.json', 'r', 'utf-8')
      except:
         self.data_o = {}
         self.saveData_p()
      else:
   ...
   def saveData_p(self):
   #-------------------------------------------------------
      with codecs.open('webteams/data/qual_in_weit.json', 'w', 'utf-8') as fp_o:
